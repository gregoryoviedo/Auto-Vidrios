...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Lista de clientes',0,0,'C');
    // Salto de línea
    $this->Ln(20);

    $this->Cell(25, 10, 'Usuario', 1, 0, 'C', 0);
	$this->Cell(70, 10, 'Nombre completo', 1, 0, 'C', 0);
	$this->Cell(18, 10, 'Cedula', 1, 0, 'C', 0);
    $this->Cell(21, 10, 'Telefono', 1, 0, 'C', 0);
...
foreach ($resultado as $row) {
	$pdf->Cell(25, 10, $row['idusuario'], 1, 0, 'C', 0);
	$pdf->Cell(70, 10, $row['nombre']." ".$row['apellido'], 1, 0, 'C', 0);
	$pdf->Cell(18, 10, $row['cedula'], 1, 0, 'C', 0);
    $pdf->Cell(21, 10, $row['telefono'], 1, 0, 'C', 0);

...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Lista de egresos',0,0,'C');
    // Salto de línea
    $this->Ln(20);

    $this->Cell(20, 10, 'Usuario', 1, 0, 'C', 0);
	$this->Cell(70, 10, 'Fecha', 1, 0, 'C', 0);
    $this->Cell(50, 10, 'Material', 1, 0, 'C', 0);
    $this->Cell(50, 10, 'Cantidad', 1, 1, 'C', 0);
...
foreach ($resultado as $row) {
    ...
    $pdf->Cell(50, 10, $row['material'], 1, 0, 'C', 0);
    $pdf->Cell(50, 10, $row['cantidad'], 1, 1, 'C', 0);

<?php include 'includePublic/header.php'; ?>
<title>Filtraciones</title>
</head>
<body>

<!--Cabeza del servicio-->
<header class="header-page-filtracion">
  <div class="background-overlay-header-page-filtracion text-white py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center justify-content-center align-self-center py-5">
          <h1 class="cabezera-servicios titulo-home text-center">Filtraciones</h1>
          <i class="line-emcabezado-servicios d-none d-sm-block d-md-block"></i>
          <p class="cabezera-servicios-parrafo">Este problema se suele dar mas con frecuencia en la temporada de lluvias, por ende se tiene que estar mas atento de algun goteo no deseado dentro de su carro, por uno o mas zonas, y de observar si avanza rapidamente</p>
          <a href="../../controller/public/CatalogoController.php?accion=mostrar" class="btn btn-outline-secondary">Catalogo</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid bg-white">
    <div class="row">
      <div class="col-lg-9 box-second" >
        <div class="mx-4">
          <h2 class="titulo-home" style="font-size: 43px;">Filtraciones</h2>
          <p>Las filtraciones de agua en autos se producen cuando el agua se acumula en su parte externa. Este exceso de agua se filtra lentamente a través de los poros hacia la parte interior del vehiculo, produciendo vías de agua y la consiguiente humedad por filtración.</p>
          <p>De esa manera es por la cual se generan filtraciones de agua en el interior de tu vehiculo</p>
          <div class="row">
            <div class="col-lg-3">
      ...
      <div class="col-lg-3 bg-white" style="margin-top: 50px;padding: 0;">
        <img src="../../Frontend/img/servicios/filtraciones/FronteFiltrado.jpg" class="img-fluid" width="350">
      </div>
    </div>
  </div>
</section>
<!--Cabeza del servicio de filtraciones por goma-->
<header class="header-page-filtracion-2">
  <div class="background-overlay-header-page-filtracion-2 text-white py-5">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <img src="../../Frontend/img/servicios/filtraciones/GomasDespegadas.jpg" class="img-fluid" width="400" style="border-radius: 20%;">
        </div>
        <div class="col-lg-7">
          <h2 class="titulo-home" style="font-size: 43px;padding-top: 50px;">Filtraciones por goma</h2>
          <p>Las gomas ademas de ser una especie de soporte para el parabrisas, tambien esta instalada es las puertas de los carros, para evitar filtraciones y en algunos casos para evitar robos, y estas mismas gomas tienen un tiempo de vida util</p>
        </div>
      </div>
    </div>
  </div>
</header>
<!--Final de las imagenes y descripcion del servicio--->
    ...
    <div class="col-lg-2 front-left">
      <div class="row hover-effects image-hover">
        <div class="mx-3 pt-5">
          <div class="col-md-12">
          <div class="image-box">
            <figure><img src="../../frontend/img/servicios/filtraciones/TapiceriaMojada.jpg" width="150" /></figure>
          </div>
        </div>
        <div class="col-md-12">
          <div class="image-box">
            <figure><img src="../../frontend/img/servicios/filtraciones/FiltracionPolvo.jpg" width="150" /></figure>
          </div>
        </div>
        </div>      
      </div>
...
<!---Final de el porque nosotros--->

<?php include 'includePublic/footer.php'; ?>
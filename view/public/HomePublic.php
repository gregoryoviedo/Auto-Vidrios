...
<!-----Inicio del encabezado principal de la pagina---->
<header class="main-header-principal">
  <div class="background-overlay-principal text-white py-5">
    <div class="container">
      <div class="row" style="margin-top: 100px;">
        <div class="col-md-12 text-center justify-content-center align-self-center">
          <h1 class="cabe titulo-home" style="font-size: 55px;">Auto Vidrios Pueblo Nuevo</h1>
          <p class="pt-5">Adelantate y registrate de una vez para ver mas opciones con nuestros servicios y productos</p>
          <a href="../../Controller/public/LoginController.php?accion=login" class="btn btn-outline-primary btn-lg text-white">Registrate</a>
        </div>
      </div>
    </div>
  </div>
</header>
<!-----Final del encabezado principal de la pagina------>
...
<!--------Inicio de citas-------->
<header class="main-header-citas">
  <div class="background-overlay-citas text-white py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-center justify-content-center align-self-center">
          ...
          <a href="../../Controller/public/LoginController.php?accion=login" class="btn btn-outline-primary btn-lg text-white">Regístrate</a>
        </div>
        <div class="col-md-6">
...
<section class="home-section-services bg-light">
  <div class="container bg-light">
    <div class="row">   
      ...
      <div class="col-lg-4">
        <a href="../../Controller/public/CatalogoController.php?accion=mostrar" class="cta-btn btn btn-primary btn-lg text-white justify-content-center">Catalogo de servicios</a>  
      </div>
    </div>
  </div>
</section>
...
<div class="container-fluid bg-light">
  <div class="row">
    <div class="col" style="padding: 0;">
      <div id="demo" class="carousel slide fondo-continuo" data-ride="carousel" style="height: 90%;" >
        <!--Indicadores-->
        ...
        <div class="carousel-inner">
  	    ...
  	    <!--Controles-->
        <a href="#demo" class="carousel-control-prev" data-slide="prev"><spam class="carousel-control-prev-icon"></spam></a> 
        <a href="#demo" class="carousel-control-next" data-slide="next"><spam class="carousel-control-next-icon"></spam></a> 
      </div>
    </div>
  </div>
</div>

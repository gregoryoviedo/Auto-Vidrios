...
<!--Cabeza del servicio-->
<header class="header-page-manilla">
  <div class="background-overlay-header-page-manilla text-white py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center justify-content-center align-self-center py-5">
          <h1 class="cabezera-servicios titulo-home text-center">Manillas</h1>
          <i class="line-emcabezado-servicios d-none d-sm-block d-md-block"></i>
          <p class="cabezera-servicios-parrafo"><p>Pieza fundamente para poder dar inicio al mecanismo de la cremallera, mediante la fuerza y velodidad que se ejecute sobre ella, para posteriormente bajar o subir el vidrios completamente</p>
  ...
  <div class="container-fluid bg-white">
    <div class="row">
      <div class="col-lg-9 box-second" >
        <div class="mx-4">
          <h2 class="titulo-home" style="font-size: 43px;">Instalacion de manillas</h2>
          <p>Contamos con la capacidad de la instalacion y si es ser posible hasta reparacion, de todo tipo de manillas para tu automovil, con un montaje perfecto que este en buena sincronizacion con la cremallera del vidrios</p>
          <p>Ven con nosotros, estamos totalmente preparados para ayudarte con tu problema de manillas</p>
          <div class="row">
            <div class="col-lg-3">
      ...
      <div class="col-lg-3 bg-white" style="margin-top: 15px;padding: 0;">
        <img src="../../Frontend/img/servicios/manillas/manilla2.jpg" class="img-fluid" width="350">
      </div>
    </div>
  </div>
</section>
<!--Cabeza del servicio de mas manillas-->
<header class="header-page-manilla-2">
  <div class="background-overlay-header-page-manilla-2 text-white py-5">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <img src="../../Frontend/img/servicios/manillas/manillareparada.jpg" class="img-fluid" width="400" style="border-radius: 20%;">
        </div>
        <div class="col-lg-7">
          <h2 class="titulo-home" style="font-size: 43px;padding-top: 50px;">Manillas</h2>
          <p>Tambien somos capaces de encarganos de alguna manillas personalizada que desees traer, nosotros con todo el gusto del mundo de la instalamos sin mayor complicacion con nuestros empleados de experiencia</p>
      </div>
    </div>
  </div>
</header>
    ...
    <div class="col-lg-2 front-left">
      <div class="row hover-effects image-hover">
        <div class="mx-3 pt-5">
          <div class="col-md-12">
          <div class="image-box">
            <figure><img src="../../frontend/img/servicios/manillas/ManillaPlateada.jpg" width="150" /></figure>
          </div>
        </div>
        <div class="col-md-12">
          <div class="image-box">
            <figure><img src="../../frontend/img/servicios/manillas/ManillaBonita.jpg" width="150" /></figure>
          </div>
        </div>
        </div>      
      </div>

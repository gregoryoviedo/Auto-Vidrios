...
<h1 class="text-center titulo-home"><i class="fa fa-chalkboard-teacher"></i>  Sesiones de Administrador</h1>
  ...
  <div class="row">
    <div class="col-12">
        <div class="table-responsive bg-white" style="font-size: 12px;">
          ...
          <tbody>         
            <?php foreach ($objetoRetornadoAdministrador as $mostrarCiclo) { ?>
              <tr>

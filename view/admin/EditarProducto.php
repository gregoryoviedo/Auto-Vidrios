...
<div class="modal-header">
	<h2 class="modal-title titulo-home">Editar <?php echo $mostrarCiclo->producto; ?></h2>
...
<form role="form" action="PreciosController.php" method="POST" enctype="multipart/form-data">
    <div class="modal-body mx-0 px-0">
		<div class="form-group">
			...
			<input type="text" name="producto" value="<?php echo $mostrarCiclo->producto; ?>" class="form-control">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<input type="number" name="cantidad" value="<?php echo $mostrarCiclo->cantidad; ?>" class="form-control">
		</div>
		<div class="form-group">

...
<body>
<!--Cabeza del servicio-->
<header class="header-page-guaya">
  <div class="background-overlay-header-page-guaya text-white py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center justify-content-center align-self-center py-5">
          <h1 class="cabezera-servicios titulo-home text-center">Guaya</h1>
          <i class="line-emcabezado-servicios d-none d-sm-block d-md-block"></i>
          <p class="cabezera-servicios-parrafo">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequatm. Lorem ipsum dolor sit amet.</p>
  ...
  <div class="container-fluid bg-white">
    <div class="row">
      <div class="col-lg-9 box-second" >
        <div class="mx-4">
          <h2 class="titulo-home" style="font-size: 43px;">Instalacion de guaya</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequatm. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>          <div class="row">
            <div class="col-lg-3">
      ...
      <div class="col-lg-3 bg-white" style="margin-top: 15px;padding: 0;">
        <img src="../../Frontend/img/servicios/guaya/HiloDeGuaya.jpg" class="img-fluid" width="350">
      </div>
    </div>
  </div>
</section>
<!--Cabeza del servicio de cremallera electrica-->
<header class="header-page-guaya-2">
  <div class="background-overlay-header-page-guaya-2 text-white py-5">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
           <img src="../../Frontend/img/servicios/guaya/guaya3.jpg" class="img-fluid" width="400" style="border-radius: 20%;">
        </div>
        <div class="col-lg-7">
          <h2 class="titulo-home" style="font-size: 43px;padding-top: 50px;">Guaya</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequatm./p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-2 front-left">
      <div class="row hover-effects image-hover">
        <div class="mx-3 pt-5">
          <div class="col-md-12">
          <div class="image-box">
            <figure><img src="../../frontend/img/servicios/guaya/guaya.jpg" width="150" /></figure>
          </div>
        </div>
        <div class="col-md-12">
          <div class="image-box">
            <figure><img src="../../frontend/img/servicios/guaya/guaya2.jpg" width="150" /></figure>
          </div>
        </div>
        </div>      
      </div>
